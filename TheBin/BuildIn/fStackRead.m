...
workbar(0,'Reading Stack Information...','Progress',0,0,1);  
...
workbar(0,'Reading Stack...','Progress',0,0,1);                
Stack = cell(1,N);                
for n = 1:N
    x = ImageWidth(1,n);
    y = ImageLength(1,n);
    ...
    try
        ...
        workbar(1,'Reading Stack...','Progress',-1,0,1);
        warning('MATLAB:outOfMemory','Out of memory - read %4.0f of %4.0f frames',n-1,N);
        break
    end
    workbar(n/N,'Reading Stack...','Progress',-1,0,1);
end
